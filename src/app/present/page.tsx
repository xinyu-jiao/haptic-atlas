...
const horizontalLockupDark = (
  <>
    <img
      ...
      alt=""
      style={{ display: "block", width: 115, height: 115, objectFit: "contain", flexShrink: 0 }}
    />
    <div style={{ width: 1, alignSelf: "stretch", minHeight: 102, background: "#4a4a4e", flexShrink: 0 }} aria-hidden />
    <div>
      <div
        style={{
          fontSize: "1.05rem",
...
const horizontalLockupOnLight = (
  <>
    <img
      src={assetUrl(LOGO_MARK_PATH)}
      alt=""
      style={{ display: "block", width: 102, height: 102, objectFit: "contain", flexShrink: 0 }}
    />
    <div style={{ width: 1, alignSelf: "stretch", minHeight: 88, background: "#a89bb5", flexShrink: 0 }} aria-hidden />
    <div>
      <div
        style={{
          fontSize: "0.92rem",
...
const horizontalLockupVariations = (
  <>
    <img
      ...
      style={{ display: "block", width: 115, height: 115, objectFit: "contain", flexShrink: 0 }}
    />
    <div style={{ width: 1, alignSelf: "stretch", minHeight: 132, background: "#4a4a4e", flexShrink: 0 }} aria-hidden />
    <div>
      <div
        style={{
          fontSize: "0.9rem",
    ...
    <div className="dash-page present-page">
      <div className="dash-container">
        ...
        <Section>
          ...
          <div className="dash-card" style={{ padding: "1.35rem 1.6rem", marginBottom: 0 }}>
            <p className="dash-body" style={{ margin: "0 0 1.15rem", lineHeight: 1.72 }}>
            ...
            <p className="dash-body" style={{ margin: "0 0 1.15rem", lineHeight: 1.72 }}>
              The <strong style={{ color: "#fff", fontWeight: 600 }}>web layer</strong> uses{" "}
              <strong style={{ color: "#fff", fontWeight: 600 }}>Web Bluetooth API</strong> for device communication,{" "}
              <strong style={{ color: "#fff", fontWeight: 600 }}>Geolocation API</strong> for walking traces,{" "}
              <strong style={{ color: "#fff", fontWeight: 600 }}>Leaflet</strong> for route maps,{" "}
              <strong style={{ color: "#fff", fontWeight: 600 }}>Recharts</strong> for data visualization, and{" "}
              <strong style={{ color: "#fff", fontWeight: 600 }}>Firebase Firestore</strong> for cloud-based session
              records.
            </p>
            ...
            <div>
              ...
              >
                <img
                  ...
                  style={{ display: "block", width: "100%", maxWidth: "58rem", height: "auto" }}
                />
              </div>
            </div>
                ...
                >
                  ...
                  <div style={SPEC_VARIATION_INNER}>
                    <img
                      ...
                      style={{ display: "block", width: "min(100%, 15.5rem)", height: "auto", objectFit: "contain" }}
                    />
                  </div>
                </div>
                <div
