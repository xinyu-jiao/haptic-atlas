...
/**
 * Design / research timeline and slice status (formerly standalone Process page).
 */
      ...
      <div style={{ marginTop: "3rem", borderTop: "1px solid var(--dash-border)", paddingTop: "2.5rem" }}>
        ...
        <div className="dash-card">
          ...
          {MILESTONE.incomplete.map((item) => (
            <div key={item} className="dash-list-item">
              <span className="dash-list-bullet" style={{ color: "#333" }}>
                —
              </span>
              <span className="dash-list-text" style={{ color: "var(--dash-text-muted)" }}>
                {item}
              </span>
            </div>
          ))}
